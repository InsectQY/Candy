...
public extension ObservableType {
     ...
     */
    func mapAt<Result>(_ keyPath: KeyPath<Element, Result>) -> Observable<Result> {
...
public extension SharedSequenceConvertibleType {
     ...
     func mapAt<Result>(_ keyPath: KeyPath<Element, Result>) -> SharedSequence<SharingStrategy, Result> {
        self.map { $0[keyPath: keyPath] }
    }
}
