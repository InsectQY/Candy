...
class VideoHallEpisodeCell: TableViewCell {
    ...
    @IBAction private func moreBtnDidClick(_ sender: Any) {
        ...
        presentation.heightForViewController = .custom(value: ScreenHeight - VideoHallHeaderView.height)
...
extension VideoHallEpisodeCell {
    ...
    public static var kItemW: CGFloat {
        return (ScreenWidth - (VideoHallEpisodeCell.kMaxCol - 1) * VideoHallEpisodeCell.kMargin - VideoHallEpisodeCell.KInset * 2) / VideoHallEpisodeCell.kMaxCol
    }
}
